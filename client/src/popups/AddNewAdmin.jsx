          ...
          <div className="p-6">
            <header className="flex justify-between items-center mb-7 pb-5 border-b-[1px] border-[#bb6d1e]">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-[#bb6d1e]">Add New Admin</h3>
              </div>
              <img
                src={closeIcon}
                alt="close-icon" className="h-9 w-9"
            ...
            <form onSubmit={handleAddNewAdmin}>
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-900 
            rounded-md focus:outline-none text-[#bb6d1e] bg-[#FAF1EA] text-xl"
                />
              </div>
