export function generateVerificationOtpEmailTemplate(otpCode) {
    return `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #000; padding: 20px; border: 1px solid #ddd; border-radius: 8px; color: #fff;">
        ...
        <div style="text-align: center; margin: 20px 0;">
            <span style="display: inline-block; font-size: 24px; font-weight: bold; color: #000; padding: 10px 20px; background-color: #fff; border: 1px solid #ccc; border-radius: 5px;">
                ${otpCode}
            </span>
        </div>
        ...
        <p>Thank you,<br>BookFlow Team</p>
        <p style="font-size: 14px; color: #444;">This is a automated message. Please do not reply.</p>
        </footer>
    </div>`;
}
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl) {
 ...
 <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">  
    ...
    <p style="font-size: 16px; color: #ccc;">If the button above doesn’t work, you can copy and paste the following URL into your browser:</p>
    <p style="font-size: 14px; color: #fff; ">${resetPasswordUrl}</p>
    <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
        <p>Thank you,<br>BookFlow Team</p>
        <p style="font-size: 14px; color: #444;">This is an automated message. Please do not reply to this email.</p>
    </footer>
</div>
 `
